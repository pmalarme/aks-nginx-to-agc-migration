...
# This script deploys an Azure Kubernetes Service (AKS) cluster with Azure GitOps Configuration (AGC) enabled.
...
ASSOCIATION_NAME='alb-aks-with-agc-association'
